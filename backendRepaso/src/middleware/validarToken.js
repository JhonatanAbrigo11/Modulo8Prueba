...
async function validarToken(req, res, next) {
    // extraemos el header de la petición para ver el token
    ...
    // aquí se valida si el token no ha sido revocado (Logout)
    ...
    // validamos que el token que existe sea válido y no haya expirado
    try {
